...
type TenantQuery struct {
	...
	withUsers        *UserQuery
	withRoles        *RoleQuery
	withServerLeases *ServerLeaseQuery
	withBills        *BillQuery
	withModules      *TenantModuleQuery
...
func (_q *TenantQuery) QueryRoles() *RoleQuery {
...
// QueryServerLeases chains the current query on the "server_leases" edge.
func (_q *TenantQuery) QueryServerLeases() *ServerLeaseQuery {
...
func (_q *TenantQuery) QueryBills() *BillQuery {
...
func (_q *TenantQuery) QueryModules() *TenantModuleQuery {
	query := (&TenantModuleClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *TenantQuery) QueryTasks() *TaskQuery {
...
func (_q *TenantQuery) Clone() *TenantQuery {
	...
	return &TenantQuery{
		...
		withServerLeases: _q.withServerLeases.Clone(),
...
func (_q *TenantQuery) WithRoles(opts ...func(*RoleQuery)) *TenantQuery {
	query := (&RoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithServerLeases tells the query-builder to eager-load the nodes that are connected to
// the "server_leases" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TenantQuery) WithServerLeases(opts ...func(*ServerLeaseQuery)) *TenantQuery {
	query := (&ServerLeaseClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withServerLeases = query
	return _q
}
...
func (_q *TenantQuery) WithBills(opts ...func(*BillQuery)) *TenantQuery {
	query := (&BillClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TenantQuery) WithModules(opts ...func(*TenantModuleQuery)) *TenantQuery {
	query := (&TenantModuleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TenantQuery) WithTasks(opts ...func(*TaskQuery)) *TenantQuery {
	query := (&TaskClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TenantQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Tenant, error) {
	...
	if query := _q.withServerLeases; query != nil {
		if err := _q.loadServerLeases(ctx, query, nodes,
			func(n *Tenant) { n.Edges.ServerLeases = []*ServerLease{} },
			func(n *Tenant, e *ServerLease) { n.Edges.ServerLeases = append(n.Edges.ServerLeases, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withBills; query != nil {
		if err := _q.loadBills(ctx, query, nodes,
			func(n *Tenant) { n.Edges.Bills = []*Bill{} },
			func(n *Tenant, e *Bill) { n.Edges.Bills = append(n.Edges.Bills, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withModules; query != nil {
		if err := _q.loadModules(ctx, query, nodes,
			func(n *Tenant) { n.Edges.Modules = []*TenantModule{} },
			func(n *Tenant, e *TenantModule) { n.Edges.Modules = append(n.Edges.Modules, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withTasks; query != nil {
		if err := _q.loadTasks(ctx, query, nodes,
			func(n *Tenant) { n.Edges.Tasks = []*Task{} },
			func(n *Tenant, e *Task) { n.Edges.Tasks = append(n.Edges.Tasks, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TenantQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *Role)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *TenantQuery) loadServerLeases(ctx context.Context, query *ServerLeaseQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *ServerLease)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(serverlease.FieldTenantID)
	}
	query.Where(predicate.ServerLease(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.ServerLeasesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TenantQuery) loadBills(ctx context.Context, query *BillQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *Bill)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(bill.FieldTenantID)
	}
	query.Where(predicate.Bill(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.BillsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TenantQuery) loadModules(ctx context.Context, query *TenantModuleQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *TenantModule)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(tenantmodule.FieldTenantID)
	}
	query.Where(predicate.TenantModule(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.ModulesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TenantQuery) loadContracts(ctx context.Context, query *ContractQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *Contract)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(contract.FieldTenantID)
	}
...
func (_q *TenantQuery) loadTasks(ctx context.Context, query *TaskQuery, nodes []*Tenant, init func(*Tenant), assign func(*Tenant, *Task)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Tenant)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(task.FieldTenantID)
	}
	query.Where(predicate.Task(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(tenant.TasksColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
