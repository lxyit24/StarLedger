...
func (_u *RoleUpdate) SetTenant(v *Tenant) *RoleUpdate {
...
func (_u *RoleUpdate) ClearTenant() *RoleUpdate {
...
// SetTenant sets the "tenant" edge to the Tenant entity.
func (_u *RoleUpdateOne) SetTenant(v *Tenant) *RoleUpdateOne {
	return _u.SetTenantID(v.ID)
}
...
// ClearTenant clears the "tenant" edge to the Tenant entity.
func (_u *RoleUpdateOne) ClearTenant() *RoleUpdateOne {
	_u.mutation.ClearTenant()
	return _u
}
