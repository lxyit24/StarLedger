...
// The ServerLeaseFunc type is an adapter to allow the use of ordinary
// function as ServerLease mutator.
type ServerLeaseFunc func(context.Context, *ent.ServerLeaseMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ServerLeaseFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ServerLeaseMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ServerLeaseMutation", m)
}
...
// The TenantModuleFunc type is an adapter to allow the use of ordinary
// function as TenantModule mutator.
type TenantModuleFunc func(context.Context, *ent.TenantModuleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TenantModuleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TenantModuleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TenantModuleMutation", m)
}
