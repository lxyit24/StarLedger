<template>
  <div class="login-container">
    ...
    <el-dialog v-model="showRegister" title="注册新租户" width="480px" destroy-on-close>
      <el-form ref="regFormRef" :model="regForm" :rules="regRules" label-width="80px">
        <el-form-item label="租户名称" prop="tenant_name"><el-input v-model="regForm.tenant_name" placeholder="公司/组织名称" /></el-form-item>
        <el-form-item label="用户名" prop="username"><el-input v-model="regForm.username" placeholder="登录用户名" /></el-form-item>
        <el-form-item label="密码" prop="password"><el-input v-model="regForm.password" type="password" placeholder="至少6位" show-password /></el-form-item>
        <el-form-item label="真实姓名" prop="real_name"><el-input v-model="regForm.real_name" /></el-form-item>
        <el-form-item label="邮箱" prop="email"><el-input v-model="regForm.email" /></el-form-item>
        <el-form-item label="手机号" prop="phone"><el-input v-model="regForm.phone" /></el-form-item>
      </el-form>
      <template #footer>
...
const regForm = reactive({ tenant_name: '', username: '', password: '', real_name: '', email: '', phone: '' })
const regRules = {
...
.login-title { text-align: center; font-size: 28px; color: #303133; margin-bottom: 4px; }
